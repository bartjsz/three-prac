...
// https://www.udemy.com/course/threejs-tutorials/learn/lecture/43195092#overview
// Orthographic Camera
...
// Orthographic is a fixed depth. You can't zoom in or out. There is no distance from the camera. Perspective has depth. You can zoom in and out
// https://commons.wikimedia.org/wiki/File:Orthographic_view_frustum.png#/media/File:Orthographic_view_frustum.png

// orthographic good for when have window static size always constant
...
function animate() {
  ...
  // to always look at the box
  // try comment and play with it
  // stops clipping from frustum
  camera.lookAt(0, 0.5, 0);
