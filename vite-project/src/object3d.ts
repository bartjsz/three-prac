...
// https://www.udemy.com/course/threejs-tutorials/learn/lecture/43195122#overview
...
// cube.position.y = 0;
// cube.rotation.x = Math.PI / 4; //equivalent to 45 degrees on x axis
// cube.scale.x = 3;
// cube.scale.set(0.1, 2, 3); // set multiple vectors
cube.position.y = 1;
scene.add(cube);
...
function animate() {
  ...
  // renderer.render(cube, camera); // if just want to render one object here we only have cube we made.
