...
// built in geometries
// https://www.udemy.com/course/threejs-tutorials/learn/lecture/43195138#overview

// good link for matrix
...
function regenerateBoxGeometry() {
  ...
  // scale vs regrenerate/dispose.
  // Scale uses transformation matricies/matrix doesnt change underlying value just adds math function to render.
  // Regenerating/dispose recreates the values to render
  //
