...
// can uninstall dat.gui and use lil-gui
...
// alternative way if didnt npm install lil-gui
// it is part of three js so can just do below but folder structure may change in future
// import { GUI } from "three/examples/jsm/libs/lil-gui.module.min.js";

// material and lil-gui
// https://sbcode.net/threejs/lil-gui/

// preferred but computational expensive
// https://threejs.org/docs/#api/en/materials/MeshStandardMaterial

const scene = new THREE.Scene();
// meshStandard can use environment map to be visible without light
// works best with HDR images
...
// required for meshPhong and meshStandard
scene.add(light);
...
// typescript helps a lot with the properties on each of the materials
const meshes = [
